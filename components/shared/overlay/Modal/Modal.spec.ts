...
describe("Modal component", () => {
    ...
    it("dispatches close action from header and inner close variants", async () => {
        ...
        const iconsDefault = findElements(defaultElement, (currentElement) => typeof currentElement.props?.onClick === "function");
        ...
        const iconsInner = findElements(innerElement, (currentElement) => typeof currentElement.props?.onClick === "function");
        ...
        const iconsHidden = findElements(hiddenElement, (currentElement) => typeof currentElement.props?.onClick === "function");
