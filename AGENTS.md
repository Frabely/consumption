...
- Git-Workflow: `git fetch` und `git pull` duerfen immer ohne Rueckfrage ausgefuehrt werden. `git push` ebenfalls ohne Rueckfrage, sobald der User im Chat explizit zum Push auffordert.
